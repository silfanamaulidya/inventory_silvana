...
--
-- Host: localhost:3306
-- Generation Time: Apr 10, 2025 at 02:45 AM
...
(102, 'penghapus', 321, 'rp.1000', 2),
(103, 'pensil', 654, 'rp.1500', 3),
(104, 'penggaris', 987, 'rp.2000', 4);
...
CREATE TABLE `jenis` (
  ...
  `nama_jenis` varchar(9) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
