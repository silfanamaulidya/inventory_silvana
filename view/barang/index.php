...
<nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-three="dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <div class="container">
        <h1>Data barang Silfana</h1>
        <a href="view_tambah.php" class="btn btn-info"><i class="fa-solid fa-cart-plus"></i>Tambah Data barang Baru</a>
        <br></br>
                    ...
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($result=mysqli_fetch_assoc($query)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="view_edit.php?id=<?php echo $result['id_barang'];?>" class="btn btn-danger"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
